---
title: "Cofounding an NLiDB SaaS Product, Imux"
description: "When I co-founded Imux, our mission was crystal clear: we wanted to help managers and executives easily query their company databases using simple, clear…"
pubDate: 2019-01-10
categories: [Design, Product]
heroImage: "../../assets/posts/cofounding-an-nlidb-saas-product-imux/hero.jpg"
heroImageAlt: "Cofounding an NLiDB SaaS Product, Imux"
...
![Imux app UI](../../assets/posts/cofounding-an-nlidb-saas-product-imux/01.png)

![Imux app UI](../../assets/posts/cofounding-an-nlidb-saas-product-imux/02.png)

![Imux app UI](../../assets/posts/cofounding-an-nlidb-saas-product-imux/03.png)

![Imux app UI](../../assets/posts/cofounding-an-nlidb-saas-product-imux/04.png)

![Imux app UI](../../assets/posts/cofounding-an-nlidb-saas-product-imux/05.png)

![Imux app UI](../../assets/posts/cofounding-an-nlidb-saas-product-imux/06.png)

![Imux app UI](../../assets/posts/cofounding-an-nlidb-saas-product-imux/07.png)

![Imux app UI](../../assets/posts/cofounding-an-nlidb-saas-product-imux/08.png)

![Imux app UI](../../assets/posts/cofounding-an-nlidb-saas-product-imux/09.png)

![Imux app UI](../../assets/posts/cofounding-an-nlidb-saas-product-imux/10.png)

![Imux app UI](../../assets/posts/cofounding-an-nlidb-saas-product-imux/11.png)

![Imux app UI](../../assets/posts/cofounding-an-nlidb-saas-product-imux/12.png)

![Imux app UI](../../assets/posts/cofounding-an-nlidb-saas-product-imux/13.png)
